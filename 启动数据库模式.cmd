@echo off
chcp 65001 >nul 2>&1
title Diabetes Assistant - Database Mode
...
rem
rem  All real logic lives in tools\db-mode-start.js .
rem ====================================================================
...
echo.
echo ====================================================================
echo   Database Mode Launcher - Diabetes Assistant
echo   MySQL + Backend + Browser, one click
echo ====================================================================
echo.
